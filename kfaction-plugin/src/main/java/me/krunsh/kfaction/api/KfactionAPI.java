...
import me.krunsh.kfaction.api.v2.KfactionPlayerActionsProvider;
...
public class KfactionAPI {
    ...
    private final KfactionApiProvider v2;
    private final KfactionPlayerActions playerActions;
    ...
    public KfactionAPI(
        ...
        this.playerActions = new KfactionPlayerActionsProvider(plugin, v2);
    ...
    public KfactionApiV23 getV23() {
        return v2;
    }

    public KfactionPlayerActions getPlayerActions() {
    ...
    private void registerServices() {
        ...
        plugin.getLogger().info(
                "Kfaction API enregistrée: "
                        + KfactionApiV23.API_VERSION
        );
    }
